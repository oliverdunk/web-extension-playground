...
declare module "@typescript/sandbox" {
  export class TypeScriptWorker {
    ...
    getScriptKind?(fileName: string): import("typescript").ScriptKind
    getCurrentDirectory(): string
    getDefaultLibFileName(options: import("typescript").CompilerOptions): string
    isDefaultLibFileName(fileName: string): boolean
    private static clearFiles
    getSyntacticDiagnostics(fileName: string): Promise<import("typescript").Diagnostic[]>
    getSemanticDiagnostics(fileName: string): Promise<import("typescript").Diagnostic[]>
    getSuggestionDiagnostics(fileName: string): Promise<import("typescript").DiagnosticWithLocation[]>
    getCompilerOptionsDiagnostics(fileName: string): Promise<import("typescript").Diagnostic[]>
    getCompletionsAtPosition(fileName: string, position: number): Promise<import("typescript").CompletionInfo | undefined>
    getCompletionEntryDetails(
      fileName: string,
      position: number,
      entry: string
    ): Promise<import("typescript").CompletionEntryDetails | undefined>
    getSignatureHelpItems(fileName: string, position: number): Promise<import("typescript").SignatureHelpItems | undefined>
    getQuickInfoAtPosition(fileName: string, position: number): Promise<import("typescript").QuickInfo | undefined>
    getOccurrencesAtPosition(fileName: string, position: number): Promise<ReadonlyArray<import("typescript").ReferenceEntry> | undefined>
    getDefinitionAtPosition(fileName: string, position: number): Promise<ReadonlyArray<import("typescript").DefinitionInfo> | undefined>
    getReferencesAtPosition(fileName: string, position: number): Promise<import("typescript").ReferenceEntry[] | undefined>
    getNavigationBarItems(fileName: string): Promise<import("typescript").NavigationBarItem[]>
    getFormattingEditsForDocument(fileName: string, options: import("typescript").FormatCodeOptions): Promise<import("typescript").TextChange[]>
    getFormattingEditsForRange(
      fileName: string,
      start: number,
      end: number,
      options: import("typescript").FormatCodeOptions
    ): Promise<import("typescript").TextChange[]>
    ...
    ): Promise<readonly import("typescript").RenameLocation[] | undefined>
    getRenameInfo(fileName: string, positon: number, options: import("typescript").RenameInfoOptions): Promise<import("typescript").RenameInfo>
    getEmitOutput(fileName: string): Promise<import("typescript").EmitOutput>
    getCodeFixesAtPosition(
      fileName: string,
      start: number,
      end: number,
      errorCodes: number[],
      formatOptions: import("typescript").FormatCodeOptions
    ): Promise<ReadonlyArray<import("typescript").CodeFixAction>>
  ...
  export const createTypeScriptSandbox: (partialConfig: Partial<SandboxConfig>, monaco: Monaco, ts: typeof import("typescript")) => {
      ...
      lzstring: typeof import("./lzstring.min");
